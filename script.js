...
function filter() {
  let vale = "backdrop-filter: blur(" + blur.value + "px) brightness(" + brightness.value + "%) saturate(" + saturate.value + "%) hue-rotate(" + hue.value + "deg) contrast(" + contrast.value + "%)  invert(" + invert.value + "%);";
